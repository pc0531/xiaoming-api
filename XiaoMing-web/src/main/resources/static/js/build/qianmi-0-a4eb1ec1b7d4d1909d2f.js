...
var _componentBarContainer = __webpack_require__(728);

var _componentBarContainer2 = _interopRequireDefault(_componentBarContainer);

var _componentBar = __webpack_require__(732);

var _componentBar2 = _interopRequireDefault(_componentBar);

var _componentOrderServiceListBody = __webpack_require__(733);

var _componentOrderServiceListBody2 = _interopRequireDefault(_componentOrderServiceListBody);
...
var GoodsOrderList = (function (_React$Component) {
    _inherits(GoodsOrderList, _React$Component);

    function GoodsOrderList(props) {
        _classCallCheck(this, GoodsOrderList);

        _get(Object.getPrototypeOf(GoodsOrderList.prototype), 'constructor', this).call(this, props);
        this.state = {
            ready: false,
            type: "service",
            selected: "all"
    ...
    _createClass(GoodsOrderList, [{
        key: 'componentWillMount',
        value: function componentWillMount() {
            var userInfo = _utilCommonInfo2['default'].getUserInfo();
            _iflux.msg.emit('GoodsOrderList_getOrderList', userInfo.userCode);
        }
    }, {
        ...
        value: function componentDidMount() {
            ...
            mui("#aunttabbar").on('tap', 'a', function () {
                var chooseId = this.dataset.choose;
                that.setState({
                    selected: chooseId
                });
            });
        ...
        value: function render() {
            ...
            var orderList = _store2['default'].data().get("orderList");
            console.error("orderList11:" + orderList);
            return _react2['default'].createElement(
                'div',
                null,
                orderList ? _react2['default'].createElement(
                    'div',
                    null,
                    _react2['default'].createElement(
                        'header',
                        { className: 'mui-bar mui-bar-nav jzc-bar-nav linear-background' },
                        _react2['default'].createElement('a', { href: 'javascript:void(0)', className: 'mui-pull-left mui-icon mui-icon-arrowleft mui-action-back' }),
                        _react2['default'].createElement(
                            'h1',
                            { className: 'mui-title' },
                            '订单列表'
                    ...
                    _react2['default'].createElement(
                        'div',
                        { id: 'ordertab', className: 'mui-segmented-control jzc-ordlist-items', style: { margin: "1rem .2rem -1rem" } },
                        _react2['default'].createElement(
                            'a',
                            { id: 'serviceorder', className: type == "service" ? "mui-control-item mui-active" : "mui-control-item" },
                            '服务订单'
                        ),
                        _react2['default'].createElement(
                            'a',
                            { id: 'goodsorder', className: type == "goods" ? "mui-control-item mui-active" : "mui-control-item" },
                            '实物订单'
                        )
                    ),
                    _react2['default'].createElement(
                        _componentBarContainer2['default'],
                        null,
                        _react2['default'].createElement(
                            _componentBar2['default'],
                            { title: '全部', choose: 'all', selected: 'all' == selected, showed: 'service' == type },
                            _react2['default'].createElement(_componentOrderServiceListBody2['default'], { url: '/trade/queryListWithExtend', id: 'allOrderList', type: 'order', list: orderList })
                        ),
                        _react2['default'].createElement(
                            _componentBar2['default'],
                            { title: '未完成', choose: 'uncomplete', selected: 'uncomplete' == selected, showed: 'service' == type },
                            _react2['default'].createElement(_componentOrderServiceListBody2['default'], { url: '/trade/queryListWithExtend', id: 'uncompletelOrderList', type: 'order' })
                        ),
                        _react2['default'].createElement(_componentBar2['default'], { title: '已完成', choose: 'complete', selected: 'complete' == selected, showed: 'service' == type }),
                        _react2['default'].createElement(_componentBar2['default'], { title: '售后', choose: 'afterSale', selected: 'afterSale' == selected, showed: 'service' == type }),
                        _react2['default'].createElement(_componentBar2['default'], { title: '全部', choose: 'allGoods', selected: 'allGoods' == selected, showed: 'goods' == type }),
                        _react2['default'].createElement(_componentBar2['default'], { title: '未完成', choose: 'uncompleteGoods', selected: 'uncompleteGoods' == selected, showed: 'goods' == type }),
                        _react2['default'].createElement(_componentBar2['default'], { title: '已完成', choose: 'completeGoods', selected: 'completeGoods' == selected, showed: 'goods' == type })
                    ),
                    _react2['default'].createElement(_commonComponentsCommonNavigationBar2['default'], { curTab: '_orderTab' })
                ) : null
            );
        }
    }]);
...
exports['default'] = (0, _reactRouter.withRouter)((0, _iflux.connectToStore)(_store2['default'], true)(GoodsOrderList));
module.exports = exports['default'];
/*<OrderServiceListBody url="/trade/queryListWithExtend" id="completelOrderList" filterData = {complete} type="order" />*/ /*<OrderServiceListBody url="/serviceorder/queryServiceorderList" id="serviceorderList"  type="service" />*/ /*<OrderServiceListBody url="/ka/yly/entity/trade/queryListWithPic" id="allGoodsList" filterData={allGoods}  type="goods" />*/ /*<OrderServiceListBody url="/ka/yly/entity/trade/queryListWithPic" id="uncompleteGoodsList" filterData={uncompleteGoods} type="goods" />*/ /*<OrderServiceListBody url="/ka/yly/entity/trade/queryListWithPic" id="completeGoodsList" filterData = {completeGoods} type="goods" />*/
...
if(!locales[name] && typeof module !== 'undefined' && module && module.exports){try{oldLocale = globalLocale._abbr;var aliasedRequire=require;__webpack_require__(716)("./" + name);getSetGlobalLocale(oldLocale);}catch(e) {}}return locales[name];} // This function will load locale and then set the global locale.  If
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(715)(module)))
...
;(function (global, factory) {
     true ? factory(__webpack_require__(590)) : typeof define === 'function' && define.amd ? define(['../moment'], factory) : factory(global.moment);
...
var _commonTabbarRenderContent = __webpack_require__(729);

var _commonTabbarRenderContent2 = _interopRequireDefault(_commonTabbarRenderContent);

var OrderStatusBar = _react2['default'].createClass({
    displayName: 'OrderStatusBar',

    mixins: [_commonTabbarRenderContent2['default']],
    /**
     * 渲染TabBar
     *
     * @returns {XML}
    ...
    render: function render() {
        return _react2['default'].createElement(
            'div',
            { className: 'mui-content jzc-ordlist-content new2' },
            _react2['default'].createElement(
                'div',
                { id: 'aunttabbar', className: 'jzc-tab-nav js-tab-title' },
                this.props.children
            ),
            this._renderContent()
        );
...
var _LazyComponent = __webpack_require__(730);
...
var RenderContent = {
    _renderContent: function _renderContent() {
        ...
        return _children.map(function (child, i) {
            ...
            if (child) {
                return _react2['default'].createElement(_LazyComponent2['default'], { selected: selected, component: child, key: i });
            }
        });
    }
};
...
var _staticComponent = __webpack_require__(731);

var _staticComponent2 = _interopRequireDefault(_staticComponent);
 ...
 */
var LazyComponent = _react2['default'].createClass({
    ...
    render: function render() {
        ...
        return _react2['default'].createElement(
            'div',
            { style: style },
            _react2['default'].createElement(_staticComponent2['default'], { selected: selected, component: Component })
        );
    }
});
...
var StaticComponent = _react2['default'].createClass({
...
var OrderStatusBarItem = (function (_React$Component) {
    _inherits(OrderStatusBarItem, _React$Component);

    function OrderStatusBarItem(props) {
        _classCallCheck(this, OrderStatusBarItem);

        _get(Object.getPrototypeOf(OrderStatusBarItem.prototype), 'constructor', this).call(this, props);
        this.state = {
            selected: false,
            title: '',
            showed: ''
    ...
    _createClass(OrderStatusBarItem, [{
        key: 'render',
        value: function render() {
            var className = this.props.selected ? "mui-control-item mui-active" : "mui-control-item";

            return this.props.showed ? _react2['default'].createElement(
                'a',
                { href: '#', className: className, 'data-choose': this.props.choose },
                this.props.title
            ) : null;
        }
    }]);

    return OrderStatusBarItem;
})(_react2['default'].Component);
...
var _moment = __webpack_require__(590);

var _moment2 = _interopRequireDefault(_moment);

var _iflux = __webpack_require__(242);

var OrderListBody = (function (_React$Component) {
    _inherits(OrderListBody, _React$Component);

    function OrderListBody(props) {
        _classCallCheck(this, OrderListBody);

        _get(Object.getPrototypeOf(OrderListBody.prototype), 'constructor', this).call(this, props);
        this.state = {};
    }

    _createClass(OrderListBody, [{
        key: 'render',
        value: function render() {
            var leftStyle = _constants2['default'].chooseOrderIconClass(2).split('jzc-icon-left')[0];
            var iconCode = '0';
            var list = [];
            var orderList = this.props.list;
            console.error("orderList:" + orderList);
            orderList.map(function (param, index) {
                ...
                list.push(_react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'a',
                        { className: 'top' },
                        _react2['default'].createElement('span', { className: leftStyle }),
                        _react2['default'].createElement('span', { className: "iconfont icon-dingdanzhuangtai-" + iconCode }),
                        _react2['default'].createElement(
                            'div',
                            { className: 'cont' },
                            _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                ...
                                null,
                                '创建时间：',
                                (0, _moment2['default'])(param.get("addTime")).format('YYYY-MM-DD HH:mm:ss'),
                                ' '
                            )
                        )
                    )
            ...
            return _react2['default'].createElement(
                ...
                orderList ? _react2['default'].createElement(
                    'div',
                    { className: 'ordlist-tab-content active' },
                    _react2['default'].createElement(
                        'ul',
                        { className: 'jzc-ordstatus-lists', style: { paddingBottom: "2.8rem" } },
                        list
                    )
                ) : null
            );
...
module.exports = (0, _reactRouter.withRouter)(OrderListBody);
...
_iflux.msg.on('GoodsOrderList_getOrderList', function (userCode) {
    console.error("usrCode:" + userCode);
    _utilRequest2['default'].get(_constants2['default'].Host + '/order/findOrdersByUserCode', { userCode: userCode }).then(function (res) {
        if (res) {
            appStore.cursor().set("orderList", _immutable2['default'].fromJS(res.dataList));
        }
    }).fail(function (res) {
        if (res.result == 'fail') {
            mui.toast(res.msg);
