...
var Register = (function (_React$Component) {
    ...
    _createClass(Register, [{
        ...
        //D00232的定制需求，如果选择了合同才让注册
        value: function componentDidMount() {
            var that = this;
            (function (mui) {
                // 注册
                mui('.login-input-group').on('tap', '#pwdRegisterButton', function () {
                    var phoneNumber = that.state.phoneNumber; // 电话号码
                    var password = that.state.password; //密码
                    ...
                    var formData = {
                        ...
                        passWord: _utilRSA2['default'].encryptedString(password)
                    };
                    var url = _constants2['default'].Host + '/user/register';
                    _utilRequest2['default'].get(url, formData).then(function (res) {
                        mui.toast("注册成功！");
                ...
                // 去登录
                mui('.mui-content').on('tap', '#goLogin', function () {
        ...
        value: function render() {
            return _react2['default'].createElement(
                'div',
                { className: 'mui-content ex-user-login-content' },
                _react2['default'].createElement(
                    'div',
                    { className: 'top' },
                    _react2['default'].createElement('a', { href: 'javascript:void(0)', className: 'mui-pull-left mui-icon mui-icon-arrowleft go-back' }),
                    _react2['default'].createElement(
                        'h1',
                        { className: 'mui-title' },
                        '注册'
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                'button',
                                { id: 'pwdRegisterButton', type: 'button', className: 'ex-login-btn' },
                                '注册'
                            )
                        )
                    )
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'a',
                        { href: 'javascript:void(0)', id: 'goLogin' },
                        '立即登录'
                    )
                )
            );
        ...
        key: '_writePassword',
        value: function _writePassword(e) {
