...
var PayResult = (function (_Component) {
    _inherits(PayResult, _Component);

    function PayResult() {
        _classCallCheck(this, PayResult);

        _get(Object.getPrototypeOf(PayResult.prototype), 'constructor', this).apply(this, arguments);
    }
    ...
    _createClass(PayResult, [{
        ...
        value: function componentDidMount() {
            var _self = this;
            var payId = this.props.params.payId;
            _iflux.msg.emit('PayResult_findPay', payId);
            (function ($, doc) {
                $.init({
        ...
        value: function render() {
            var payInfo = _store2['default'].data().get("payInfo");
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'div',
                        { className: 'mui-scroll-wrapper jzc-scroll-tb' },
                        _react2['default'].createElement(
                            'div',
                            { className: 'mui-scroll' },
                            _react2['default'].createElement(
                                'div',
                                { className: 'jzc-pay-success' },
                                _react2['default'].createElement('img', { src: 'https://pic.qianmi.com/ejz/ejzc_app2.0/img/paysuccess.png', alt: '恭喜您支付成功' })
                            ),
                            _react2['default'].createElement(
                                'div',
                                { className: 'jzc-card-item' },
                                _react2['default'].createElement(
                                    'div',
                                    { className: 'top' },
                                    _react2['default'].createElement(
                                    ...
                                    _react2['default'].createElement(
                                        ...
                                        _react2['default'].createElement(
                                            ...
                                            null,
                                            '￥',
                                            payInfo.get("totalCash")
                                        )
                                    )
                                ),
                                _react2['default'].createElement(
                                    'div',
                                    { className: 'bottom-btn-2' },
                                    _react2['default'].createElement(
                                        'a',
                                        { href: 'javascript:void(0)', className: 'js-sendGift' },
                                        '分享'
                                    ),
                                    _react2['default'].createElement(
                                        'a',
                                        { href: 'javascript:void(0)', id: 'bindPCard'
                                        },
                                        '查看订单详情'
                                    )
                                )
                            ...
                            _react2['default'].createElement(
                                ...
                                _react2['default'].createElement(
                                    ...
                                    _react2['default'].createElement(
                                        ...
                                        null,
                                        '支付时间:',
                                        (0, _moment2['default'])(payInfo.get("time")).format('YYYY-MM-DD HH:mm:ss')
                                    )
                                )
                            )
                        )
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'nav',
                        { className: 'mui-bar mui-bar-tab jzc-default-nav-tab' },
                        _react2['default'].createElement(
                            'a',
                            { href: 'javascript:void(0)', id: 'goToIndex' },
                            '返回首页'
                        )
                    )
                ),
                _react2['default'].createElement(
                    'div',
                    { className: 'jzc-copy-password js-copy-password' },
                    _react2['default'].createElement(
                        'p',
                        null,
                        _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'a',
                        { href: 'javascript:void(0)', id: 'copyCardPwd', className: 'copyCardPwd' },
                        '复制'
                    )
                ),
                _react2['default'].createElement('div', { className: 'mui-backdrop jzc-backdrop js-backdrop' })
            );
        }
    }]);
...
exports['default'] = (0, _reactRouter.withRouter)((0, _iflux.connectToStore)(_store2['default'], true)(PayResult));
...
_iflux.msg.on('PayResult_findPay', function (payId) {
    _utilRequest2['default'].post(_constants2['default'].Host + '/pay/findByPayId', { payId: payId }).then(function (res) {
        if (res) {
            appStore.cursor().set("payInfo", _immutable2['default'].fromJS(res));
        }
    }).fail(function (res) {
        if (res.result == 'fail') {
            mui.toast(res.msg);
