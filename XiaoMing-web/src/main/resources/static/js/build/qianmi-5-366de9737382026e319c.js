...
var _store = __webpack_require__(723);
...
var My = (function (_Component) {
    ...
    function My(props) {
        ...
        _get(Object.getPrototypeOf(My.prototype), 'constructor', this).call(this, props);
        this.state = {};
    }
    ...
    _createClass(My, [{
        ...
        value: function componentDidMount() {
            var _userInfo = _utilCommonInfo2['default'].getUserInfo();
            _iflux.msg.emit('My_getUserInfo', _userInfo.userName);
        }
    }, {
        key: '_myInfoCount',
        value: function _myInfoCount() {
        ...
        value: function componentDidUpdate() {
            ...
            mui('.jzc-my-top').on('tap', '#logIn', function () {
                _utilCommonInfo2['default'].checkLogin();
            });
        ...
        value: function render() {
            ...
            var messageClass = unReadMessageCount > 0 ? 'unread' : '';
            var _userInfo = _utilCommonInfo2['default'].getUserInfo();
            var userInfo = _userInfo && _userInfo !== 'null' && _userInfo.userName ? _userInfo : {};
            var userInfo_find = _store2['default'].data().get("userInfo");
            return _react2['default'].createElement(
                'div',
                { className: 'animated fadeIn mui-fullscreen' },
                _react2['default'].createElement(
                    'header',
                    { className: 'mui-bar jzc-bar-nav linear-background', id: 'myHeader' },
                    _react2['default'].createElement(
                        'h1',
                        { className: 'mui-title' },
                        '我的'
                    ),
                    _react2['default'].createElement('a', { id: 'messageCenter', href: 'javascript:void(0)', className: 'mui-pull-right iconfont icon-xinfeng ' + messageClass }),
                    _react2['default'].createElement('a', { id: 'shoppingCart', href: 'javascript:void(0)', className: 'mui-pull-right iconfont icon-gouwuchekongxin' })
                ),
                _react2['default'].createElement(
                    'div',
                    ...
                    _react2['default'].createElement(
                        'div',
                        { className: 'jzc-my-top' },
                        _utilCommonInfo2['default'].checkLogin({ type: 0 }) ? _react2['default'].createElement(
                            'div',
                            { className: 'use-phone-msg' },
                            _react2['default'].createElement(
                                'div',
                                null,
                                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'div',
                        { className: 'mui-scroll-wrapper jzc-scroll-tb', id: 'pullRefresh' },
                        _react2['default'].createElement(
                            'div',
                            { className: 'mui-scroll' },
                            _react2['default'].createElement(
                                'div',
                                { className: 'jzc-my-menu' },
                                _react2['default'].createElement(
                                    'a',
                                    { id: 'couponList' },
                                    _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                'div',
                                { className: 'jzc-row-box' },
                                _react2['default'].createElement(
                                    'a',
                                    { className: 'mui-navigate-right line', id: 'myInfo' },
                                    '我的信息'
                                ),
                                _react2['default'].createElement(
                                    'a',
                                    { className: 'mui-navigate-right line', id: 'myHealthList' },
                                    '我的报告'
                                ),
                                _react2['default'].createElement(
                                    'div',
                                    ...
                                    _react2['default'].createElement(
                                        'a',
                                        { className: 'mui-navigate-right', id: 'feedBack' },
                                        '意见反馈'
                                    )
                                ),
                                _react2['default'].createElement(
                                    'a',
                                    { className: 'jzc-layout-btn line', id: 'logOut' },
                                    _react2['default'].createElement('i', { className: 'iconfont icon-web-icon-' }),
                                    '切换账号'
                                )
                            )
                        )
                ...
                _react2['default'].createElement(_commonComponentsCommonNavigationBar2['default'], { curTab: '_myTab' })
            );
        }
    }]);
...
exports['default'] = (0, _reactRouter.withRouter)((0, _iflux.connectToStore)(_store2['default'], true)(My));
...
_iflux.msg.on('My_getUserInfo', function (username) {
    _utilRequest2['default'].get(_constants2['default'].Host + '/user/findUserInfoByUsername', { username: username }).then(function (res) {
        if (res) {
            appStore.cursor().set("userInfo", _immutable2['default'].fromJS(res));
        }
    }).fail(function (res) {
        if (res.result == 'fail') {
            mui.toast(res.msg);
